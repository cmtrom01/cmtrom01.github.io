        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <span className="email"><i className="icon-mail"></i> cmtrom01@louisville.edu</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://github.com/cmtrom01" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
